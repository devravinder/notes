...
- Code Commit (GIT), Amplify, Cognito, DynamoDB, Lambda, API Gateway
- S3, CloudFront, Route53 - CloudMap
- ECS, ECR, EC2
- EBS volumes
- Loadbalancer
- CloudWatch
...
- `Error: Cannot perform an interactive login from a non TTY device`
  ...
  - use: `docker login -u AWS -p $(aws ecr get-login-password --region <region>) <account>.dkr.ecr.<region>.amazonaws.com`
